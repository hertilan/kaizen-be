...
async function main() {
  ...
  // 24. Seed Engineering Projects
  const engProjects = [
    {
      id: "prj-001",
      projectNumber: "PRJ-2026-001",
      projectName: "Kigali Heights Commercial Plumbing & HVAC Installation",
      clientName: "Kigali Heights Real Estate Ltd",
      clientContact: "+250 788 345 678",
      ownerId: "u6",
      ownerName: "Emmanuel Bizimana",
      startDate: "2026-08-01",
      endDate: "2026-10-30",
      status: "IN_PROGRESS",
      quotationRef: "QT-2026-042",
      lpoRef: "LPO-KH-8891",
      location: "Kigali Heights, Kimihurura",
      description: "Complete commercial plumbing, pressure fitting and HVAC duct installation for Block B.",
    },
    {
      id: "prj-002",
      projectNumber: "PRJ-2026-002",
      projectName: "Nyabugogo Logistics Warehouse Steel Framework",
      clientName: "East Africa Logistics Parks Ltd",
      clientContact: "+250 788 912 345",
      ownerId: "usr-eng-002",
      ownerName: "Patrick Bizimana",
      startDate: "2026-07-15",
      endDate: "2026-09-15",
      status: "INVOICED",
      quotationRef: "QT-2026-058",
      lpoRef: "LPO-EAL-012",
      invoiceRef: "INV-ENG-104",
      location: "Nyabugogo Commercial Zone",
      description: "Structural steel roof truss fabrication, crane rigging and cladding installation.",
    },
    {
      id: "prj-003",
      projectNumber: "PRJ-2026-003",
      projectName: "Gikondo Industrial Yard Paving & Heavy Drainage System",
      clientName: "Gikondo Commercial Complex Ltd",
      clientContact: "+250 788 567 890",
      ownerId: "u6",
      ownerName: "Emmanuel Bizimana",
      startDate: "2026-06-01",
      endDate: "2026-08-20",
      status: "COMPLETED",
      quotationRef: "QT-2026-011",
      lpoRef: "LPO-GCC-441",
      invoiceRef: "INV-ENG-089",
      location: "Gikondo Industrial Zone",
      description: "Excavation, reinforced culvert drainage channels and interlocking paver installation.",
    },
    {
      id: "prj-004",
      projectNumber: "PRJ-2026-004",
      projectName: "Kimironko Health Center Electrical & Solar Backup",
      clientName: "Gasabo District Infrastructure Board",
      clientContact: "+250 788 234 567",
      ownerId: "usr-eng-003",
      ownerName: "Divine Uwase",
      startDate: "2026-09-01",
      endDate: "2026-11-15",
      status: "LPO_RECEIVED",
      quotationRef: "QT-2026-079",
      lpoRef: "LPO-GDB-902",
      location: "Kimironko Sector, Gasabo",
      description: "3-phase power distribution, automatic transfer switch and 15kVA solar inverter installation.",
    },
    {
      id: "prj-005",
      projectNumber: "PRJ-2026-005",
      projectName: "Bugesera Access Road Water Supply Mainline",
      clientName: "Bugesera Infrastructure Development Corp",
      clientContact: "+250 788 112 233",
      ownerId: "usr-eng-003",
      ownerName: "Divine Uwase",
      startDate: "2026-09-10",
      endDate: "2026-12-01",
      status: "QUOTED",
      quotationRef: "QT-2026-095",
      location: "Bugesera Highway Km 14",
      description: "110mm HDPE water pipeline laying, trenching and pressure valve testing.",
    },
  ];
  for (const p of engProjects) {
    await prisma.engProject.upsert({ where: { id: p.id }, update: p, create: p });
  }
  console.log(`✅ Seeded ${engProjects.length} Engineering projects`);

  // 25. Seed Engineering Transactions
  const engTransactions = [
    {
      id: "tx-eng-001",
      projectId: "prj-001",
      date: "2026-08-05",
      description: "Mobilization advance payment received from client",
      type: "INCOME",
      amount: 15000000,
      accountId: "acc-001",
    ...
    },
    {
      ...
      projectId: "prj-001",
      date: "2026-08-10",
      description: "Site plumbers and HVAC technicians weekly wage payroll",
      type: "EXPENSE",
    ...
    },
    {
      ...
      projectId: "prj-001",
      date: "2026-08-15",
      description: "PPR PN20 pressure pipes and fittings internal stock draw from Quincaillerie",
      type: "EXPENSE",
      expenditureCategory: "Purchase of material",
      amount: 4800000,
      accountId: "acc-101",
      accountName: "Quincaillerie (Retail Ledger)",
    ...
    },
    {
      ...
      projectId: "prj-001",
      date: "2026-08-20",
      description: "Scaffolding and pipe-threading machine monthly rental",
      type: "EXPENSE",
      expenditureCategory: "Renting",
      amount: 850000,
      accountId: "acc-001",
      accountName: "Bank Account (Primary)",
    },
    {
      ...
      projectId: "prj-002",
      date: "2026-07-20",
      description: "First milestone payment on LPO-EAL-012",
      type: "INCOME",
      amount: 28000000,
      accountId: "acc-001",
      accountName: "Bank Account (Primary)",
    },
    {
      ...
      projectId: "prj-002",
      date: "2026-07-25",
      description: "Structural steel I-beams and welding electrodes procurement",
      type: "EXPENSE",
      expenditureCategory: "Purchase of material",
      amount: 14200000,
      accountId: "acc-001",
    ...
    },
    {
      ...
      projectId: "prj-002",
      date: "2026-08-02",
      description: "50-ton mobile crane hire for steel truss erection",
      type: "EXPENSE",
      expenditureCategory: "Renting",
      amount: 3200000,
      accountId: "acc-002",
      accountName: "Bank Sub-Account",
    },
    {
      id: "tx-eng-008",
      projectId: "prj-002",
      date: "2026-08-12",
      description: "Site welding crew wages and daily lunch allowance",
      type: "EXPENSE",
      expenditureCategory: "Wages",
      amount: 1950000,
      accountId: "acc-003",
    ...
    },
    {
      ...
      projectId: "prj-003",
      date: "2026-06-10",
      description: "Full contract value payment received on Invoice INV-ENG-089",
      type: "INCOME",
      amount: 18500000,
      accountId: "acc-001",
      accountName: "Bank Account (Primary)",
    },
    {
      ...
      projectId: "prj-003",
      date: "2026-06-15",
      description: "CIMERWA cement and heavy paving blocks site delivery",
      type: "EXPENSE",
      expenditureCategory: "Purchase of material",
      amount: 8900000,
      accountId: "acc-102",
      accountName: "Wholesaler (Wholesale Ledger)",
      isInternalSupply: true,
    },
    {
      id: "tx-eng-011",
      projectId: "prj-003",
      date: "2026-06-25",
      description: "Excavator and compactor machine transport & fuel",
      type: "EXPENSE",
      expenditureCategory: "Transportation",
      amount: 1650000,
      accountId: "acc-003",
      accountName: "Petty Cash",
    },
  ];
  for (const t of engTransactions) {
    await prisma.engTransaction.upsert({ where: { id: t.id }, update: t, create: t });
  }
  console.log(`✅ Seeded ${engTransactions.length} Engineering transactions`);
